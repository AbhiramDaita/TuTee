...
class AddUser : AppCompatActivity() {
    lateinit var btn_addStudent: Button
    lateinit var btn_addParent: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        intent = getIntent()
        val userId = intent.getStringExtra("teacherId")
        val email = intent.getStringExtra("email")
        val password = intent.getStringExtra("password")
        btn_addStudent.setOnClickListener(View.OnClickListener {
            val intent = Intent(this@AddUser, AddStudent::class.java)
            intent.putExtra("teacherId", userId)
            intent.putExtra("email", email)
            intent.putExtra("password", password)
            startActivity(intent)
        })
        btn_addParent.setOnClickListener(View.OnClickListener {
            val intent = Intent(this@AddUser, AddParent::class.java)
            intent.putExtra("teacherId", userId)
            intent.putExtra("email", email)
            intent.putExtra("password", password)
            startActivity(intent)
